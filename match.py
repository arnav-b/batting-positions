...
class Match(object):
    ...
    def get_dates(self):
        ...
        dates = split(split('    |\(', str(dates))
        return dates

# match = Match('https://www.espncricinfo.com/series/19430/scorecard/1183533/australia-vs-new-zealand-2nd-test-icc-world-test-championship-2019-2021')
# df = match.bat_dfs[1]
# fow = df['BATSMEN'].iloc[-1]
# fow = split(':|\(|-', fow)
